...
func (runner *ClassificationAccuracyTestRunner) determineMatchedIndustry(tc ClassificationTestCase, result *classification.ClassificationCodesInfo) string {
	...
	industryKeywords := map[string][]string{
		...
		"Restaurant":               {"restaurant", "dining", "food", "cuisine", "kitchen", "cafe", "bistro", "eatery", "diner", "grill", "bar", "buffet", "catering", "fast food", "fine dining", "casual dining", "pizza", "burger", "sandwich", "coffee", "bakery", "ice cream", "seafood", "steakhouse", "italian", "mexican", "thai", "indian", "asian", "fusion", "breakfast", "brunch", "lunch", "dinner", "meal", "menu", "chef", "cook", "serve", "eat", "drink", "wine", "beer", "cocktail", "appetizer", "entree", "dessert", "takeout", "delivery", "catering", "food truck", "street food", "gourmet", "authentic", "traditional", "fresh", "organic", "local", "seasonal", "specialty", "premium", "upscale", "family-friendly", "casual", "quick service", "full service", "fine dining", "casual dining", "fast casual", "quick service", "table service", "counter service", "self service", "buffet", "all you can eat", "unlimited", "variety", "diverse", "international", "ethnic", "regional", "local", "farm to table", "sustainable", "healthy", "vegetarian", "vegan", "gluten free", "dietary", "specialty", "custom", "made to order", "fresh made", "homemade", "artisan", "craft", "premium", "quality", "excellent", "outstanding", "amazing", "delicious", "tasty", "flavorful", "spicy", "mild", "sweet", "savory", "rich", "light", "hearty", "comfort", "home style", "traditional", "classic", "modern", "contemporary", "innovative", "creative", "unique", "special", "signature", "famous", "popular", "favorite", "best", "top", "leading", "premier", "elite", "luxury", "high end", "upscale", "fine", "gourmet", "culinary", "chef", "professional", "expert", "skilled", "experienced", "trained", "certified", "award winning", "recognized", "acclaimed", "renowned", "famous", "popular", "busy", "crowded", "packed", "full", "reservations", "waiting", "line", "queue", "busy", "popular", "crowded", "packed", "full", "busy", "popular", "crowded", "packed", "full"},
