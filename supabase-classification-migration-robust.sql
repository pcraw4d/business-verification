-- KYB Platform - Classification System Database Migration (ROBUST VERSION)
...
-- =============================================================================
-- CLEAN SLATE APPROACH - DROP ALL EXISTING TABLES FIRST
-- =============================================================================
...
CREATE INDEX idx_industry_keywords_industry_id ON industry_keywords(industry_id);
CREATE INDEX idx_industry_keywords_keyword ON industry_keywords(keyword);
CREATE INDEX idx_industry_keywords_active ON industry_keywords(is_active);

-- Classification codes table indexes
CREATE INDEX idx_classification_codes_industry_id ON classification_codes(industry_id);
...
CREATE INDEX idx_classification_codes_active ON classification_codes(is_active);

-- Industry patterns table indexes
CREATE INDEX idx_industry_patterns_industry_id ON industry_patterns(industry_id);
...
CREATE INDEX idx_keyword_weights_weight ON keyword_weights(weight);

-- Classification accuracy metrics table indexes
CREATE INDEX idx_classification_accuracy_industry_id ON classification_accuracy_metrics(industry_id);
CREATE INDEX idx_classification_accuracy_percentage ON classification_accuracy_metrics(accuracy_percentage);
