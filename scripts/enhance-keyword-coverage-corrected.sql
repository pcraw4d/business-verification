-- =============================================================================
-- COMPREHENSIVE KEYWORD COVERAGE ENHANCEMENT - CORRECTED
-- =============================================================================
-- This script uses the exact industry names from the database
-- =============================================================================
...
-- Software Development Keywords (ID: 44)
...
FROM industries i, (VALUES
    ...
    ('software architecture', 0.85), ('code development', 0.85),
...
-- Technology Services Keywords (ID: 45)
INSERT INTO industry_keywords (industry_id, keyword, weight) 
SELECT i.id, k.keyword, k.weight
FROM industries i, (VALUES
...
-- Medical Practices Keywords (ID: 24)
INSERT INTO industry_keywords (industry_id, keyword, weight) 
SELECT i.id, k.keyword, k.weight
FROM industries i, (VALUES
...
-- Healthcare Services Keywords (ID: 25)
INSERT INTO industry_keywords (industry_id, keyword, weight) 
SELECT i.id, k.keyword, k.weight
FROM industries i, (VALUES
    ...
    ('wellness center', 0.7), ('healthcare center', 0.7),
...
-- Healthcare Technology Keywords (ID: 27)
INSERT INTO industry_keywords (industry_id, keyword, weight) 
SELECT i.id, k.keyword, k.weight
FROM industries i, (VALUES
...
-- Investment Services Keywords (ID: 30)
INSERT INTO industry_keywords (industry_id, keyword, weight) 
SELECT i.id, k.keyword, k.weight
FROM industries i, (VALUES
...
DO $$
BEGIN
    RAISE NOTICE 'KYB Platform Keyword Coverage Enhancement - Corrected Version completed successfully!';
    RAISE NOTICE 'Added comprehensive keywords for Technology, Healthcare, Financial Services, and Food & Beverage industries';
    RAISE NOTICE 'Enhanced keyword coverage using exact industry IDs and names from database';
    RAISE NOTICE 'Ready for testing and validation';
END $$;
