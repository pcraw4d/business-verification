-- =====================================================
-- Expand Code Metadata Table with Additional Codes (CLEAN VERSION)
-- Purpose: Add more comprehensive code coverage across industries
-- OPTIMIZATION #6.2: Code Metadata Table Expansion
-- 
-- NOTE: This script uses ON CONFLICT to handle duplicates gracefully.
-- If a code already exists from populate_code_metadata.sql, it will be updated.
-- =====================================================
...
-- =====================================================
-- Part 3: Additional MCC Codes (excluding duplicates from populate_code_metadata.sql)
-- =====================================================
...
-- Additional Healthcare (excluding 8011, 8021, 8041, 8042, 8043, 8049, 8050 which are in populate_code_metadata.sql)
('MCC', '8062', 'Hospitals', 
...
-- Additional Food & Beverage (excluding 5811, 5812, 5813, 5814 which are in populate_code_metadata.sql)
-- Professional Services
